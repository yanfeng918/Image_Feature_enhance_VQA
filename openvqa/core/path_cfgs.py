...
class PATH:
    ...
    def init_path(self):
        ...
        # self.DATA_ROOT = '/media/yanfeng/750/MCAN/'+ '/coco_extract'
        # self.DATA_ROOT = '/media/yanfeng/750/my_vqa_extract/grid/'
        # self.DATA_ROOT = '/media/yanfeng/750/my_vqa_extract/grid_resnest2/'
        # self.DATA_ROOT = '/media/yanfeng/750/my_vqa_extract/grid_152_lr/'
        self.DATA_ROOT = '/media/yanfeng/750/my_vqa_extract/grid_PCA/'
        self.DATA_ROOT = '/home/yanfeng/Pictures/features/region_101_all_100/'
        self.DATA_ROOT = '/home/yanfeng/Pictures/features/region_101_all_100_fix'
        self.DATA_ROOT = '/media/yanfeng/WD1500/my_extract_feature/region_152_offcial_fpn'


        self.DATA_PATH = {
            'vqa': self.DATA_ROOT,
            # 'vqa_raw': '/media/yanfeng/750/MCAN',
            'vqa_raw': '/media/yanfeng/WD1500/MCAN',
            'gqa': '/media/yanfeng/750/MCAN',
        ...
        self.RAW_PATH = {
            'vqa': {
                'train': self.DATA_PATH['vqa_raw'] + '/vqa_raw' + '/v2_OpenEnded_mscoco_train2014_questions.json',
                'train-anno': self.DATA_PATH['vqa_raw'] + '/vqa_raw' + '/v2_mscoco_train2014_annotations.json',
                'val': self.DATA_PATH['vqa_raw'] + '/vqa_raw' + '/v2_OpenEnded_mscoco_val2014_questions.json',
                'val-anno': self.DATA_PATH['vqa_raw'] + '/vqa_raw' + '/v2_mscoco_val2014_annotations.json',
                'vg': self.DATA_PATH['vqa_raw'] + '/vqa_raw' + '/VG_questions.json',
                'vg-anno': self.DATA_PATH['vqa_raw'] + '/vqa_raw' + '/VG_annotations.json',
                'test': self.DATA_PATH['vqa_raw'] + '/vqa_raw' + '/v2_OpenEnded_mscoco_test2015_questions.json',
            },
            'gqa': {
